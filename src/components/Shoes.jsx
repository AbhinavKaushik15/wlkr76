    ...
    <div className="w-full">
      <div ref={child1} className="w-full h-[100vh] bg-white flex pt-[105px] justify-center gap-14">
        {seventySix.map((items, index)=>{
          ...
          <button style={{backgroundColor: items.btnbg}} className="mt-[75px] tracking-tighter py-2 px-10 rounded-full text-white font-[900]">
            AJOUTER AU PANIER
          </button>
        </div>
        })}
      ...
      <div ref={contain} className="relative w-full h-[100vh] bg-white overflow-hidden">
        <div>
